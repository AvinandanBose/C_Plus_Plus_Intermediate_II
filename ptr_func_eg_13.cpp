...
int multiply(int, int, int[][10], int, int[][10], int[][10]);
using namespace std;
int main()
{
...
int initializeToZero(int a[][10], int m, int n)
{
    for (int i = 0; i < m; i++)
    {
        for (int j = 0; j < n; j++)
...
int multiply(int m1, int n1, int a[][10], int m2, int b[][10], int c[][10])
{
    for (int i = 0; i < m1; i++)
    {
        for (int j = 0; j < m2; j++)
