...
int multiplication(int[][1], int[][10], int[][10], int, int);
using namespace std;
int main()
{
    rules();
...
void displayRes(int c[][10], int m, int n)
{
    for (int i = 0; i < m; i++)
    {
        cout << "|";
...
int multiplication(int a[][1], int b[][10], int c[][10], int m, int n)
{
    for (int i = 0; i < m; i++)
    {
        for (int j = 0; j < n; j++)
