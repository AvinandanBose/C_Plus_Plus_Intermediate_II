...
int main()
{
    ...
    if (getRowLength == getColumnLength)
    {
        ...
        cout << "\n";
        cout << " Lower Triangular Matrix  :(m x n) :" << endl;
        cout << "\n";
        for (int i = 0; i < getRowLength; i++)
        {
 ...
 * |            a[2][2]|
 *
 * Lower Triangular Matrix with Diagonal and Upper Triangular Matrix as Zeroes::
 * |a[0][0]     0          0|
 * |a[1][0] a[1][1]        0|
 * |a[2][0] a[2][1]  a[2][2]|
 *
 * Only Lower Triangular Matrix with Diagonal :
 * |                    |
 * |a[1][0]             |
 * |a[2][0] a[2][1]     |
 *
 ...
 *
 * Similarly,
 * We print the elements when :  i>j which are only Lower triangular matrix:
 * Those elements areLower  Triangular Matrix.
 *
 *
 *
 *
